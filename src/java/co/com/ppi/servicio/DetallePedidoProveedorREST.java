...
public class DetallePedidoProveedorREST {
    ...
    @Path("/consultarAll")
    public ArrayList<DetallePedidoProveedor> listar(@QueryParam("seleccionar")String seleccionar,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/consultar")
    public ArrayList<DetallePedidoProveedor> consultarDetallePedidoProveedor(@QueryParam("idPedidoProveedor")int idPedidoProveedor,
    ...
    @Path("/insertar")
    public String insertarDetallePedidoProveedor(@QueryParam("idPedidoProveedor")int idPedidoProveedor,
                                                 @QueryParam("idInsumo")int idInsumo,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/actualizar")
    public String actualizarDetallePedidoProveedor(@QueryParam("idPedidoProveedor")int idPedidoProveedor,
                                                   @QueryParam("idInsumo")int idInsumo,
                                                   @QueryParam("cantidad") int cantidad,
                                                   @QueryParam("precio") int precio){
        DetallePedidoProveedorDAO dao = new DetallePedidoProveedorDAO();
